...
export function Footer() {
  return (
    <footer className="relative bg-slate-950 text-white py-8 mt-12 border-t border-amber-600/25">
      ...
      <div className="container mx-auto px-4 pt-2">
        <div className="text-center mb-6">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6">
            ...
            <Link href="https://www.gamstop.co.uk/" className="opacity-90 hover:opacity-100 transition-opacity text-xs font-bold text-white border border-amber-500/50 rounded-lg px-3 py-2 bg-slate-900/90 hover:bg-slate-800/90">
        ...
        <div className="mb-6">
          <Link href="/" className="flex items-center justify-center gap-3 hover:opacity-90 transition-opacity">
            <div className="w-10 h-10 flex items-center justify-center rounded-full ring-2 ring-amber-500/50 ring-offset-2 ring-offset-slate-950">
              <Image src="/logo.png" alt="Site logo" width={32} height={32} />
            </div>
            <div>
        ...
        <div className="flex flex-wrap justify-center gap-x-8 gap-y-3 text-sm mb-8 border-y border-slate-800 py-5">
          ...
          <Link href="/responsible-gaming" className="text-slate-300 hover:text-amber-400 font-medium transition-colors">
            Responsible gaming
          </Link>
          <Link href="/cookie-policy" className="text-slate-300 hover:text-amber-400 font-medium transition-colors">
            Cookie policy
          </Link>
          <Link href="/privacy-policy" className="text-slate-300 hover:text-amber-400 font-medium transition-colors">
            Privacy policy
          </Link>
        </div>

        <div className="text-center space-y-2">
          <p className="text-slate-500 text-sm">© 2026 BestUKBingo.com. All rights reserved.</p>
